...
@RestController
@RequestMapping("/api/gestioneau-kafka")
public class GestioneauKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GestioneauKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GestioneauKafkaResource(KafkaProperties kafkaProperties) {
